module.exports = {
    ...
    execute(message, args, Discord, db){
        ...
        .addFields(
            ...
            {name: 'Exaroton', value: 'Exaroton is different to other hosts, they make you buy credits which then you pay for server in them. Their price is 1 credit / 1 GB RAM / 1 hour. So if you wanted to run a 24/7 server with about 4gb ram (good for a private server, not a public oneW really) you would need over $50 to run it for just one month, on pebblehost you could get a 25gb server that runs 24/7 for 1 month or a birdflop server with 20gb of ram for $40 for one month (both of these are the hosting highest premium plans) instead of 4gb for 1 month. They also dont let you upload custm plugins or server jars. Exaroton oversells extremly. NEVER USE THEM'}
