module.exports = {
    ...
    execute(message, args, Discord, db){
        ...
        .setDescription('Here are some hosting suggestions, currently these are only ones im familiar with')
        ...
        .addFields(
            ...
            {name: 'ForestRacks', value:"ForestRacks is another cheap one I have come across. I have not used it yet so I can't say if it's good or bad."},
